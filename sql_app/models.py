...
from sql_app.database import Base # 已声明的数据库
"""row：行    column：列"""
...
class HuaweiTotalClick(Base):
    ...
    INDUSTRY = Column(String(128, collation='utf8_general_ci'),nullable=False, server_default='', comment="行业")
    MERCHANT_NAME = Column(String(128, collation='utf8_general_ci'), nullable=False, server_default='', comment="商家昵称")
    LOCATED_FIELD = Column(String(128, collation='utf8_general_ci'), nullable=False, server_default='', comment="所在域")
...
class HuaweiServiceNumber(Base):
    ...
    __table_args__ = (UniqueConstraint('MERCHANT_NAME', 'DATA_TIME', name='UK_MERCHANT_DATE'),)  # 联合唯一
    ID = Column(BigInteger, primary_key=True, autoincrement=True,nullable=False, comment="ID")
    SERVICE_NAME = Column(String(128, collation='utf8_general_ci'), nullable=False, server_default='', comment="服务号名称")
    INDUSTRY = Column(String(128, collation='utf8_general_ci'),nullable=False, server_default='', comment="行业")
    MERCHANT_NAME = Column(String(128, collation='utf8_general_ci'), nullable=False, server_default='', comment="商家昵称")
    LOCATED_FIELD = Column(String(128, collation='utf8_general_ci'), nullable=False, server_default='', comment="所属域")
